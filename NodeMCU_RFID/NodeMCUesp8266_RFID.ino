...
String serverName = "http://192.168.254.195:8000";

const char* ssid = "GlobeAtHome_422E1"; // Replace with WIFI SSID
const char* password = "3524B7C3"; // Replace with WIFI Password
...
constexpr uint8_t PIC_PIN1 = D0;
constexpr uint8_t PIC_PIN2 = D1;
